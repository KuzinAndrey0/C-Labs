...
while test -f ./func_tests/data/"$file"; do #Проверять все файлы с позитивными тестами

    fileOut="pos_""$num""_out.txt"
    fileKey="pos_""$num""_args.txt"
    if [ -f ./func_tests/data/"$fileKey" ]; then
        key="./func_tests/data/""$fileKey"
    else
        key=""
    fi
    eval ./func_tests/scripts/pos_case.sh ./func_tests/data/"$file" ./func_tests/data/"$fileOut" "$key";
    returnCode="$?"
...
while test -f ./func_tests/data/"$file"; do #Проверять все файлы с негативными тестами    
    ...
    eval ./func_tests/scripts/neg_case.sh ./func_tests/data/"$file" "$key"
