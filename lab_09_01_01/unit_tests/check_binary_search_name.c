...
START_TEST(middle)
{
    ...
    int found = binary_search_name(film_p, "TEST1", 3);
...
START_TEST(first)
{
    ...
    int found = binary_search_name(film_p, "TEST2", 3);
...
START_TEST(last)
{
    ...
    int found = binary_search_name(film_p, "TEST3", 3);
...
Suite *suite_create_binary_search_name(void)
{
    Suite *suite = suite_create("binary_search_name");
...
int check_binary_search_name(void)
{
    int failed_count;
    Suite *suite = suite_create_binary_search_name();
